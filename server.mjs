...
const GITHUB_CLIENT_SECRET = process.env.GITHUB_CLIENT_SECRET || '03bc8d55baa1b578e1ccc95787494b25e76c997d';
...
app.get('/api/auth/github/callback', async (req, res) => {
    ...
    try {
        ...
        res.redirect(`/dashboard.html?github_user=${encodedUser}`);
    } catch(err) {
        console.error("GitHub Auth Error:", err);
        res.status(500).send("GitHub Auth Error: " + err.message);
    }
});
